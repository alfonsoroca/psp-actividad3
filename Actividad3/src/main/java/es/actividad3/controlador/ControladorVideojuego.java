package es.actividad3.controlador;
...
import es.actividad3.persistencia.DaoVideojuego;
...
public class ControladorVideojuego {
	...
	// GET
	// Obtener la lista de videojuegos completa. Vamos a devolver la información en formato
	// JSON.
