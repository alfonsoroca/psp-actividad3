package es.actividad3.persistencia;

import java.util.ArrayList;

import org.springframework.stereotype.Component;
import es.actividad3.modelo.entidad.Videojuego;
...
public class DaoVideojuego {
	...
	public Videojuego update(Videojuego v) {
		...
		System.out.println("No se puede actualizar el videojuego porque no existe.");
		return null;
	}

	/**
	 * Método que añade un videojuego a la lista de videojuegos si no existe su id.
	 * 
	...
	public Videojuego add(Videojuego v) {
		...
		if (idNombreExiste == false) {
			listaJuegos.add(v);
			System.out.println("Añadido a la lista " + v);
			return v;
		}
		System.out.println(
